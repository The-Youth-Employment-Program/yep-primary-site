    ...
    <footer className="py-6 bg-salmon-red text-salmon-light-g2">
      ...
      <div className="grid justify-center pt-6 lg:justify-between">
        ...
        <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
          ...
          <a rel="noopener noreferrer" target="_blank" href="#" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-salmon-green dark:text-salmon-light-g2">
