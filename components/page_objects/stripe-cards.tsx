        ...
        {props.stripeCard?.map((cards,i) => {
            return (
                <div key={i} className=" py-3 mt-4 mx-4 rounded-lg shadow-md">
                    ...
                    <a className="flex items-center mt-4 px-5 hover:text-salmon-tan text-salmon-red tracking-wider uppercase font-semibold text-lg" data-tina-field={tinaField(this, "actionCall")} href={cards?.stripeCall?.link || "#"}>{cards?.stripeCall?.label}
