...
export function TextBox(props: PageSectionTextBox) {
    ...
    if (!props.text_color) { mainstyle = `${props.bg_color} py-10 sm:py-20 lg:py-40 text-salmon-dark-g2 w-full px-5 sm:px-10 md:px-20 rounded-lg` }
    let textalign = `${props.text_alignment} ml-2 mt-4`

    return(
        <>
        { props.bg_img && 
            <section className="relative bg-origin-content bg-cover bg-center saturate-50 bg-no-repeat rounded-b-lg" style={{backgroundImage:`url('${props.bg_img}')`}}> {/* p-0 sm:p-10 */}
                <div className="backdrop-blur-3xl px-10 py-5 sm:px-16 sm:py-8 md:px-24 md:py-12 lg:px-32 lg:py-16 text-salmon-light-g2 font-bold text-lg rounded-b-lg"> {/* sm:px-24 sm:py-12 md:px-32 md:py-16 sm:my-2 sm:mx-5 md:my-5 md:mx-10   w-full sm:w-fit*/}
                    ...
                    <div className={textalign} data-tina-field={tinaField(props, "sectionText")}>
                        <TinaMarkdown content={props.sectionText} components={{
                                ...
                                li: props => <li className="px-4 list-disc" {...props} />,
                            }}
                        />
                    </div>
                </div>
                ...
                <div className={mainstyle}>
                    ...
                    <div className={textalign} data-tina-field={tinaField(props, "sectionText")}>
                        <TinaMarkdown content={props.sectionText} components={{
                                h1: props => <h1 className="mt-4 text-2xl font-semibold" {...props} />,
                                h2: props => <h2 className="mt-3 text-xl font-medium" {...props} />,
                                p: props => <p className="pt-6 xl:text-lg" {...props} />,
